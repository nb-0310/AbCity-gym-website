...
function Pricing() {
  const arr1 = ["24/7 Gym Access", "Access to all equipments", "Unlimited Access to Yoga Classes", "Unlimited Access to Meditation Classes", "Locker & Shower Access"]

  const arr2 = ["24/7 Gym Access", "Access to all equipments", "Unlimited Access to Yoga Classes", "Locker & Shower Access", "Sauna Access", "Access to Crossfit Classes"]

  const arr3 = ["24/7 Gym Access", "Access to all equipments", "Unlimited Access to Yoga Classes", "Locker & Shower Access", "Sauna Access", "Personal Trainer for each classes", "Personal Dietician", "Access to Boxing, Karate & Crossfit Classes"]
      ...
      <section id="pricing" className="pricing-section relative">
        <div className="container page-padding py-[12rem] ">
          ...
          <div className="flex gap-10 mt-32 relative z-[2] md1000:flex-col md1000:items-center ">
            <PricingBox img={Img1} price="999" plan="Beginners" list={arr1} />
            <PricingBox img={Img2} price="1799" plan="Pro" list={arr2} />
            <PricingBox img={Img3} price="2999" plan="Premium" list={arr3} />
          </div>
          <img
            src={BgDumbell}
            alt="bg_icon"
