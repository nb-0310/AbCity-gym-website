...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Marc Fitt", job: "Bodybuilding Trainer" },
    { img: Trainer2, name: "Alex Costa", job: "Fitness Trainer" },
    { img: Trainer3, name: "Ana June", job: "Personal Trainer & Dietician" },
  ];
        ...
        {trainers.map((train, id) => (
          ...
          >
            <img
              ...
              } ${train.name === "Alex Costa" ? "translate-y-5 scale-110" : ""}`}
            />
            <img
              style={{ transition: "all 0.3s" }}
              src={TrainerBg}
