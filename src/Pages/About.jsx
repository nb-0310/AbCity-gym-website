          ...
          <div className="grid grid-cols-[1fr_1fr] h-[60rem] md1000:grid-cols-1">
            ...
            <div className="flex flex-col !text-left relative items-right justify-center md1000:items-center md1000:!text-center">
              ...
              <p className="text-[#646464] font-medium text-[15px] max-w-[50rem] ">
                At AbCity, we are dedicated to helping you achieve the body of
            ...
            <div className="grid grid-cols-2 grid-rows-2 w-full min620:grid-cols-1">
              <div className="w-full bg-white h-[43rem] flex flex-col justify-center items-center text-center px-[100px] min800:px-[10px]">
                ...
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ea nemo adipisci error necessitatibus, voluptates dolorum, expedita similique nam assumenda repellendus ipsam unde vel tempore itaque voluptatum odit hic tenetur natus!
                </p>
              </div>
              ...
              <div className="w-full bg-white h-[43rem] flex flex-col justify-center items-center text-center px-[100px] min800:px-[10px]">
                ...
                <h2 className="text-[36px] font-bold mt-3">Our History</h2>
                <p className="text-[16px] font-medium text-[#646464] mt-5">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquam tempora sequi assumenda impedit praesentium, beatae voluptatum dolorem illo illum temporibus nihil molestias molestiae deleniti, suscipit voluptates eius quo eligendi nemo?
                </p>
              </div>
            </div>
          </div>
